...
Bookends.TOKEN_CATALOG = {
    ...
    { _("Page / progress"), {
        ...
        { "%book_pct_left", _("Book percentage left") },
        { "%chap_pct", _("Chapter percentage read") },
        { "%chap_pct_left", _("Chapter percentage left") },
    ...
    { _("Session / reading"), {
        ...
        { "%pages_today", _("Pages read today (all books)") },
        { "%time_today", _("Reading time today (all books)") },
        { "%speed", _("Reading speed (pages/hour)") },
        { "%avg_page_time", _("Average time per page") },
        { "%book_read_time", _("Total reading time for book") },
        { "%book_pages_read", _("Pages read of this book (lifetime)") },
        { "%book_pct_read", _("Book read percentage (skip-aware)") },
        { "%days_reading_book", _("Days reading this book") },
        { "%pages_per_day", _("Pages per day for this book") },
    }},
    { _("Device"), {
...
Bookends.CONDITIONAL_CATALOG = {
    { _("Reference"), {
        ...
        { "[if:pages_today>0]...[/if]", _("Pages read today") },
        { "[if:book_pct_read>50]...[/if]", _("Book read % (skip-aware)") },
